# create User
_name = "system"; _email= "system@smoothrunning.com"; _pass="system"; _keep_team_id = 1; _guest = false
user01=User.create!(name: _name, email: _email, password: _pass, keep_team_id:  _keep_team_id, guest: _guest)
_name = Faker::Name.unique.name; _email= Faker::Internet.email; _pass="passwd"; _keep_team_id = 1; _guest = false
user02=User.create!(name: _name, email: _email, password: _pass, keep_team_id:  _keep_team_id, guest: _guest)
_name = Faker::Name.unique.name; _email= Faker::Internet.email; _pass="passwd"; _keep_team_id = 1; _guest = false
user03=User.create!(name: _name, email: _email, password: _pass, keep_team_id:  _keep_team_id, guest: _guest)
_name = "島 達郎"; _email= "shima.tatsurou@gmail.com"; _pass="tshima"; _keep_team_id = 1; _guest = false
user04=User.create!(name: _name, email: _email, password: _pass, keep_team_id:  _keep_team_id, guest: _guest)
_name = "ゲストユーザ"; _email= "guest@smoothrunning.com"; _pass="9760632280502371"; _keep_team_id = 1; _guest = true
user_guest=User.create!(name: _name, email: _email, password: _pass, keep_team_id:  _keep_team_id, guest: _guest)
